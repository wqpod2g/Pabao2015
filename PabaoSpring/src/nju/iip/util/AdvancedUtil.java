...
public class AdvancedUtil {
	 ...
	 * @return
	 */
	public static boolean validateAccessToken(String openId, String AccessToken) {
		boolean flag = false;
		...
		log.info("检验授权凭证（access_token）是否有效:" + jsonObject.toString());
