...
<script src="CrazyFinger2/js/jquery-1.10.1.min.js" ></script>
<script src="CrazyFinger2/js/CrazyFinger.js" ></script>
<script src=" https://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
<link rel="stylesheet" href="CrazyFinger2/css/CrazyFinger.css">
</head>
<body>
...
<script type="text/javascript">
		window.shareData = {
			...
			"timeLineLink" : 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='+'${appID}'+'&redirect_uri='+'${ServerDomain}'+'/Game/CrazyFinger2.do&response_type=code&scope=snsapi_userinfo&state=CrazyFinger2#wechat_redirect',
			"tTitle" : "疯狂手指二-根本停不下来，玩过之后我的手指已经不是我的了！",
